...
export default [
  ...
  layout("routes/app-layout.jsx", [
    ...
    route("/app/affordability", "routes/app/affordability.jsx"),
    route("/app/blended-rate", "routes/app/blended-rate.jsx"),
    route("/app/calc-mortgage", "routes/app/calc-mortgage.jsx"),
    route("/app/dscr-calc", "routes/app/dscr-calc.jsx"),
    route("/app/refi-analysis", "routes/app/refi-analysis.jsx"),
    route("/app/va-entitlement", "routes/app/va-entitlement.jsx"),
    ...
    route("/app/nexa-broker-comp-calc", "routes/app/nexa-broker-comp-calc.jsx"),
    route("/app/nexa-nondel-comp-calc", "routes/app/nexa-nondel-comp-calc.jsx"),
