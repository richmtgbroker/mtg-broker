...
var pricingHTML = ''
  ...
  /* ======== COMPARISON TABLE (v4.2 — Progressive Disclosure Grid) ======== */
  ...
  + '<div class="grid-header-label">Features</div>'
  + '<div class="grid-header-plan tier-lite"><span class="grid-plan-name">LITE</span><span class="grid-plan-price">Free</span></div>'
  + '<div class="grid-header-plan tier-plus"><span class="grid-plan-name">PLUS</span><span class="grid-plan-price">$49/mo</span></div>'
  + '<div class="grid-header-plan tier-pro"><span class="grid-badge">Recommended</span><span class="grid-plan-name">PRO</span><span class="grid-plan-price">$79/mo</span></div>'
  + '</div>'

  /* --- Category: Search & Data --- */
  + '<div class="grid-category"><span class="grid-cat-text">Search &amp; Data</span></div>'
  + '<div class="grid-row">'
  + '<div class="grid-feature">AI Powered Loan Search</div>'
  + '<div class="grid-val tier-lite"><span class="val-limited">Limited</span></div>'
  + '<div class="grid-val tier-plus"><span class="val-full">Full Access</span></div>'
  + '<div class="grid-val tier-pro"><span class="val-pro">Full Access</span></div>'
  + '</div>'
  + '<div class="grid-row">'
  + '<div class="grid-feature">Loan Product Search</div>'
  + '<div class="grid-val tier-lite"><span class="val-limited">Limited</span></div>'
  + '<div class="grid-val tier-plus"><span class="val-full">Full Access</span></div>'
  + '<div class="grid-val tier-pro"><span class="val-pro">Full Access</span></div>'
  + '</div>'
  + '<div class="grid-row">'
  + '<div class="grid-feature">Lender &amp; Vendor Directory</div>'
  + '<div class="grid-val tier-lite">' + tableCheckSvg + '</div>'
  + '<div class="grid-val tier-plus">' + tableCheckSvg + '</div>'
  + '<div class="grid-val tier-pro">' + tableCheckSvg + '</div>'
  + '</div>'
  + '<div class="grid-row">'
  + '<div class="grid-feature">Saved Favorites</div>'
  + '<div class="grid-val tier-lite"><span class="val-dash">\u2014</span></div>'
  + '<div class="grid-val tier-plus">' + tableCheckSvg + '</div>'
  + '<div class="grid-val tier-pro">' + tableCheckSvg + '</div>'
  + '</div>'

  /* --- Category: Calculators --- */
  + '<div class="grid-category"><span class="grid-cat-text">Calculators</span></div>'
  + '<div class="grid-row">'
  + '<div class="grid-feature">Number of Calculators</div>'
  + '<div class="grid-val tier-lite"><span class="val-limited">Basic</span></div>'
  + '<div class="grid-val tier-plus"><span class="val-full">All 14+</span></div>'
  + '<div class="grid-val tier-pro"><span class="val-pro">All 14+</span></div>'
  + '</div>'
  + '<div class="grid-row">'
  + '<div class="grid-feature">Save Scenarios</div>'
  + '<div class="grid-val tier-lite"><span class="val-dash">\u2014</span></div>'
  + '<div class="grid-val tier-plus"><span class="val-limit">10 per tool</span></div>'
  + '<div class="grid-val tier-pro"><span class="val-pro-bold">Unlimited</span></div>'
  + '</div>'
  + '<div class="grid-row">'
  + '<div class="grid-feature">PDF Export</div>'
  + '<div class="grid-val tier-lite"><span class="val-dash">\u2014</span></div>'
  + '<div class="grid-val tier-plus"><span class="val-dash">\u2014</span></div>'
  + '<div class="grid-val tier-pro">' + tableCheckSvg + '</div>'
  + '</div>'

  /* --- Category: Pipeline --- */
  + '<div class="grid-category"><span class="grid-cat-text">Pipeline</span></div>'
  + '<div class="grid-row">'
  + '<div class="grid-feature">Pipeline Tracking</div>'
  + '<div class="grid-val tier-lite"><span class="val-dash">\u2014</span></div>'
  + '<div class="grid-val tier-plus"><span class="val-limit">25 loans</span></div>'
  + '<div class="grid-val tier-pro"><span class="val-pro-bold">Unlimited</span></div>'
  + '</div>'
  + '<div class="grid-row">'
  + '<div class="grid-feature">Pipeline Export</div>'
  + '<div class="grid-val tier-lite"><span class="val-dash">\u2014</span></div>'
  + '<div class="grid-val tier-plus"><span class="val-dash">\u2014</span></div>'
  + '<div class="grid-val tier-pro"><span class="val-pro">CSV / Excel</span></div>'
  + '</div>'

  /* --- Category: Support & Extras --- */
  + '<div class="grid-category"><span class="grid-cat-text">Support &amp; Extras</span></div>'
  + '<div class="grid-row">'
  + '<div class="grid-feature">Support</div>'
  + '<div class="grid-val tier-lite"><span class="val-muted">Email</span></div>'
  + '<div class="grid-val tier-plus"><span class="val-normal">Email</span></div>'
  + '<div class="grid-val tier-pro"><span class="val-pro">Priority</span></div>'
  + '</div>'
  + '<div class="grid-row">'
  + '<div class="grid-feature">Referral Program</div>'
  + '<div class="grid-val tier-lite"><span class="val-dash">\u2014</span></div>'
  + '<div class="grid-val tier-plus"><span class="val-dash">\u2014</span></div>'
  + '<div class="grid-val tier-pro">' + tableCheckSvg + '</div>'
  + '</div>'
