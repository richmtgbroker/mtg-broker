...
var pricingHTML = ''
  ...
  /* ======== COMPARISON TABLE (v4.2 — Bold Striped Table) ======== */
  ...
  /* --- Table Header with blue gradient, plan names + prices, Best Value badge --- */
  + '<thead><tr>'
  ...
  + '<th class="plan-col pro-col"><div class="plan-col-header"><span class="best-value-badge">Best Value</span><span class="plan-col-name">PRO</span><span class="plan-col-price">$79/mo</span></div></th>'
  + '</tr></thead>'
  ...
  + '<tr><td class="feature-name-cell">AI Powered Loan Search</td><td class="feature-value"><span class="pill pill-gray">Limited</span></td><td class="feature-value"><span class="pill pill-green">Full Access</span></td><td class="feature-value pro-col"><span class="pill pill-green">Full Access</span></td></tr>'
  + '<tr><td class="feature-name-cell">Loan Product Search</td><td class="feature-value"><span class="pill pill-gray">Limited</span></td><td class="feature-value"><span class="pill pill-green">Full Access</span></td><td class="feature-value pro-col"><span class="pill pill-green">Full Access</span></td></tr>'
  + '<tr><td class="feature-name-cell">Lender &amp; Vendor Directory</td><td class="feature-value"><span class="pill pill-green">' + tableCheckSvg + '</span></td><td class="feature-value"><span class="pill pill-green">' + tableCheckSvg + '</span></td><td class="feature-value pro-col"><span class="pill pill-green">' + tableCheckSvg + '</span></td></tr>'
  + '<tr><td class="feature-name-cell">Saved Favorites</td><td class="feature-value"><span class="pill pill-muted">\u2014</span></td><td class="feature-value"><span class="pill pill-green">' + tableCheckSvg + '</span></td><td class="feature-value pro-col"><span class="pill pill-green">' + tableCheckSvg + '</span></td></tr>'
  ...
  + '<tr><td class="feature-name-cell">Number of Calculators</td><td class="feature-value"><span class="pill pill-gray">Basic</span></td><td class="feature-value"><span class="pill pill-green">All 14+</span></td><td class="feature-value pro-col"><span class="pill pill-green">All 14+</span></td></tr>'
  + '<tr><td class="feature-name-cell">Save Scenarios</td><td class="feature-value"><span class="pill pill-muted">\u2014</span></td><td class="feature-value"><span class="pill pill-amber">10 per tool</span></td><td class="feature-value pro-col"><span class="pill pill-blue">Unlimited</span></td></tr>'
  + '<tr><td class="feature-name-cell">PDF Export</td><td class="feature-value"><span class="pill pill-muted">\u2014</span></td><td class="feature-value"><span class="pill pill-muted">\u2014</span></td><td class="feature-value pro-col"><span class="pill pill-green">' + tableCheckSvg + '</span></td></tr>'
  ...
  + '<tr><td class="feature-name-cell">Pipeline Tracking</td><td class="feature-value"><span class="pill pill-muted">\u2014</span></td><td class="feature-value"><span class="pill pill-amber">25 loans</span></td><td class="feature-value pro-col"><span class="pill pill-blue">Unlimited</span></td></tr>'
  + '<tr><td class="feature-name-cell">Pipeline Export</td><td class="feature-value"><span class="pill pill-muted">\u2014</span></td><td class="feature-value"><span class="pill pill-muted">\u2014</span></td><td class="feature-value pro-col"><span class="pill pill-green">CSV / Excel</span></td></tr>'
  ...
  + '<tr><td class="feature-name-cell">Support</td><td class="feature-value"><span class="pill pill-gray">Email</span></td><td class="feature-value"><span class="pill pill-gray">Email</span></td><td class="feature-value pro-col"><span class="pill pill-green">Priority</span></td></tr>'
  + '<tr><td class="feature-name-cell">Referral Program</td><td class="feature-value"><span class="pill pill-muted">\u2014</span></td><td class="feature-value"><span class="pill pill-muted">\u2014</span></td><td class="feature-value pro-col"><span class="pill pill-green">' + tableCheckSvg + '</span></td></tr>'
